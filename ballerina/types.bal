...
# Represents the Queries record for the operation: post-/marketing/v3/marketing-events/events/{externalEventId}/cancel_cancel
public type PostMarketingV3MarketingEventsEventsExternaleventidCancel_cancelQueries record {
...
# Represents the Queries record for the operation: post-/marketing/v3/marketing-events/events/{externalEventId}/{subscriberState}/email-upsert_upsertByContactEmail
public type PostMarketingV3MarketingEventsEventsExternaleventidSubscriberstateEmailUpsert_upsertbycontactemailQueries record {
    # The accountId that is associated with this marketing event in the external event application
    string externalAccountId;
};
...
# Represents the Queries record for the operation: delete-/marketing/v3/marketing-events/events/{externalEventId}_archive
public type DeleteMarketingV3MarketingEventsEventsExternaleventid_archiveQueries record {
    # The accountId that is associated with this marketing event in the external event application
    string externalAccountId;
};
...
# Represents the Queries record for the operation: get-/marketing/v3/marketing-events/participations/{marketingEventId}/breakdown_getParticipationsBreakdownByMarketingEventId
public type GetMarketingV3MarketingEventsParticipationsMarketingeventidBreakdown_getparticipationsbreakdownbymarketingeventidQueries record {
...
# Represents the Queries record for the operation: post-/marketing/v3/marketing-events/events/{externalEventId}/complete_complete
public type PostMarketingV3MarketingEventsEventsExternaleventidComplete_completeQueries record {
    # The accountId that is associated with this marketing event in the external event application.
    string externalAccountId;
};

# Represents the Queries record for the operation: post-/marketing/v3/marketing-events/attendance/{externalEventId}/{subscriberState}/email-create_recordByContactEmails
public type PostMarketingV3MarketingEventsAttendanceExternaleventidSubscriberstateEmailCreate_recordbycontactemailsQueries record {
    # The accountId that is associated with this marketing event in the external event application
    string externalAccountId?;
};
...
# Represents the Queries record for the operation: post-/marketing/v3/marketing-events/attendance/{externalEventId}/{subscriberState}/create_recordByContactIds
public type PostMarketingV3MarketingEventsAttendanceExternaleventidSubscriberstateCreate_recordbycontactidsQueries record {
    # The accountId that is associated with this marketing event in the external event application
    string externalAccountId?;
};
...
# Represents the Queries record for the operation: patch-/marketing/v3/marketing-events/events/{externalEventId}_update
public type PatchMarketingV3MarketingEventsEventsExternaleventid_updateQueries record {
    # The accountId that is associated with this marketing event in the external event application
    string externalAccountId;
};
...
# Represents the Queries record for the operation: get-/marketing/v3/marketing-events/participations/contacts/{contactIdentifier}/breakdown_getParticipationsBreakdownByContactId
public type GetMarketingV3MarketingEventsParticipationsContactsContactidentifierBreakdown_getparticipationsbreakdownbycontactidQueries record {
    # The limit for response size. The default value is 10, the max number is 100
    int:Signed32 'limit = 10;
    # The participation state value. It may be REGISTERED, CANCELLED, ATTENDED, NO_SHOW
    string state?;
...
# Represents the Queries record for the operation: get-/marketing/v3/marketing-events/events/{externalEventId}_getDetails
public type GetMarketingV3MarketingEventsEventsExternaleventid_getdetailsQueries record {
    # The accountId that is associated with this marketing event in the external event application
    string externalAccountId;
};

# Represents the Queries record for the operation: get-/marketing/v3/marketing-events/participations/{externalAccountId}/{externalEventId}/breakdown_getParticipationsBreakdownByExternalEventId
public type GetMarketingV3MarketingEventsParticipationsExternalaccountidExternaleventidBreakdown_getparticipationsbreakdownbyexternaleventidQueries record {
    # The identifier of the Contact. It may be email or internal id.
    string contactIdentifier?;
    # The limit for response size. The default value is 10, the max number is 100
    int:Signed32 'limit = 10;
...
# Represents the Queries record for the operation: post-/marketing/v3/marketing-events/events/{externalEventId}/{subscriberState}/upsert_upsertByContactId
public type PostMarketingV3MarketingEventsEventsExternaleventidSubscriberstateUpsert_upsertbycontactidQueries record {
    # The accountId that is associated with this marketing event in the external event application
    string externalAccountId;
};
...
# Represents the Queries record for the operation: get-/marketing/v3/marketing-events/events/search_doSearch
public type GetMarketingV3MarketingEventsEventsSearch_dosearchQueries record {
...
# Represents the Queries record for the operation: get-/marketing/v3/marketing-events/
public type GetMarketingV3MarketingEventsQueries record {
    # The limit for response size. The default value is 10, the max number is 100
    int:Signed32 'limit = 10;
    # The cursor indicating the position of the last retrieved item.
    string after?;
